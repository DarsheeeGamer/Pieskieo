...
fn test_num_format_alias() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("1,000".to_string()))
    );
}
...
fn test_format_currency_default_usd() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("$1,234.50".to_string()))
    );
}
...
fn test_format_percent_two_decimals() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("45.67%".to_string()))
    );
}
...
fn test_percent_format_alias() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("50.0%".to_string()))
    );
}
...
fn test_format_bytes_zero() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("0 B".to_string()))
    );
}
...
fn test_humanize_bytes_alias() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("512 B".to_string()))
    );
}
...
fn test_ordinal_suffix_4th() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("4th".to_string()))
    );
}
...
fn test_ordinal_alias() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("5th".to_string()))
    );
}
...
fn test_int_to_roman_4() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("IV".to_string()))
    );
}
...
fn test_int_to_roman_14() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("XIV".to_string()))
    );
}
...
fn test_int_to_roman_2024() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("MMXXIV".to_string()))
    );
}
...
fn test_num_to_words_forty_two() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("forty-two".to_string()))
    );
}
...
fn test_num_to_words_one_hundred() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("one hundred".to_string()))
    );
}
...
fn test_humanize_duration_alias() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("1m".to_string()))
    );
}
...
fn test_clean_phone_strips_formatting() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"ph": "+1 (555) 123-4567"}),
    )
    .unwrap();
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("15551234567".to_string()))
    );
}
...
fn test_normalize_phone_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"ph": "(800) 555-0199"}),
    )
    .unwrap();
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("8005550199".to_string()))
    );
}
...
fn test_luhn_check_valid_visa() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"txt": "4532015112830366"}),
    )
    .unwrap();
...
fn test_luhn_check_invalid() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"txt": "1234567890123456"}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = LUHN_CHECK(txt) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
...
fn test_wrap_text_word_boundaries() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"txt": "one two three four"}),
    )
    .unwrap();
...
fn test_format_number_integer_no_decimals() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("9,999".to_string()))
    );
}
...
fn test_format_currency_gbp() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("£99.99".to_string()))
    );
}
...
fn test_ordinal_suffix_13th_special_case() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("13th".to_string()))
    );
}
...
fn test_int_to_roman_9() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("IX".to_string()))
    );
}
...
fn test_num_to_words_nineteen() {
    ...
    assert_eq!(
        r.rows[0].data.get("out"),
        Some(&Value::String("nineteen".to_string()))
    );
}
