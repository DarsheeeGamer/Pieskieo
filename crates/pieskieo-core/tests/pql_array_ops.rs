...
fn test_array_rotate_positive() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 3, 4, 5], "nv": 2}),
    )
    .unwrap();
...
fn test_array_rotate_negative() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 3], "nv": -1}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = ARRAY_ROTATE(arr, nv) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
...
fn test_rotate_array_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [10, 20, 30], "nv": 1}),
    )
    .unwrap();
...
fn test_array_take_while_basic() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 3, 4, 5], "thresh": 3}),
    )
    .unwrap();
...
fn test_take_while_lt_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [5, 1, 2, 3], "thresh": 5}),
    )
    .unwrap();
...
fn test_array_take_while_all() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 3], "thresh": 10}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = ARRAY_TAKE_WHILE(arr, thresh) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
...
fn test_drop_while_lt_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 6, 3], "thresh": 5}),
    )
    .unwrap();
...
fn test_array_frequencies_integers() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 2, 3, 3, 3]}),
    )
    .unwrap();
...
fn test_value_counts_alias() {
    ...
    match r.rows[0].data.get("out") {
        Some(Value::Object(m)) => {
            assert_eq!(
                to_i64(m.get("1").unwrap()),
                2,
                "expected count 2 for key '1'"
            );
            assert_eq!(
                to_i64(m.get("2").unwrap()),
                1,
                "expected count 1 for key '2'"
            );
        }
        other => panic!("expected Object, got {:?}", other),
    }
...
fn test_array_nlargest_basic() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [3, 1, 4, 1, 5, 9, 2, 6], "nv": 3}),
    )
    .unwrap();
...
fn test_top_n_values_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [10, 20, 5, 15], "nv": 2}),
    )
    .unwrap();
...
fn test_set_union_basic() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2, 3], "a2": [3, 4, 5]}),
    )
    .unwrap();
...
fn test_set_intersect_basic() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2, 3], "a2": [2, 3, 4]}),
    )
    .unwrap();
...
fn test_set_difference_basic() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2, 3], "a2": [2, 3]}),
    )
    .unwrap();
...
fn test_set_is_subset_true() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2], "a2": [1, 2, 3]}),
    )
    .unwrap();
...
fn test_is_subset_alias_false() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 4], "a2": [1, 2, 3]}),
    )
    .unwrap();
...
fn test_set_is_superset_true() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2, 3], "a2": [1, 2]}),
    )
    .unwrap();
...
fn test_set_equals_true() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2, 3], "a2": [3, 1, 2]}),
    )
    .unwrap();
...
fn test_array_set_eq_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 1, 2], "a2": [2, 1]}),
    )
    .unwrap();
...
fn test_array_moving_sum_basic() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 3, 4, 5], "kv": 3}),
    )
    .unwrap();
    ...
    match r.rows[0].data.get("out") {
        Some(Value::Array(a)) => {
            ...
            assert!(
                (to_f64(&a[0]) - 6.0).abs() < 0.001,
                "window 0: expected 6.0, got {}",
                to_f64(&a[0])
            );
            assert!(
                (to_f64(&a[1]) - 9.0).abs() < 0.001,
                "window 1: expected 9.0, got {}",
                to_f64(&a[1])
            );
            assert!(
                (to_f64(&a[2]) - 12.0).abs() < 0.001,
                "window 2: expected 12.0, got {}",
                to_f64(&a[2])
            );
        }
        other => panic!("expected Array, got {:?}", other),
...
fn test_rolling_sum_array_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [2, 4, 6, 8], "kv": 2}),
    )
    .unwrap();
...
fn test_array_dot_product_basic() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2, 3], "a2": [4, 5, 6]}),
    )
    .unwrap();
...
fn test_dot_product_alias() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1.0, 0.0], "a2": [0.0, 1.0]}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = ARRAY_DOT_PRODUCT(a1, a2) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
...
fn test_array_take_while_none() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [5, 6, 7], "thresh": 3}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = ARRAY_TAKE_WHILE(arr, thresh) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
...
fn test_array_nlargest_zero() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 3], "nv": 0}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = ARRAY_NLARGEST(arr, nv) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
...
fn test_array_moving_sum_window_one() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"arr": [1, 2, 3], "kv": 1}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = ARRAY_MOVING_SUM(arr, kv) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
...
fn test_array_outer_product_sizes() {
    ...
    db.put_doc_ns(
        ...
        Some("t"),
        Uuid::new_v4(),
        serde_json::json!({"a1": [1, 2, 3], "a2": [4, 5]}),
    )
    .unwrap();
    let mut p = Parser::new(r#"QUERY t COMPUTE out = ARRAY_OUTER_PRODUCT(a1, a2) SELECT out;"#);
    let r = ex.execute(p.parse().unwrap()).unwrap();
    match r.rows[0].data.get("out") {
        Some(Value::Array(outer)) => {
            ...
            for inner_row in outer {
                match inner_row {
                    Value::Array(inner) => {
                        assert_eq!(inner.len(), 2, "each row should have 2 elements")
                    }
